...
// Esperar 5 segundos y luego mostrar el toast de "info"
window.onload = function() {
    // Ocultar todos los toasts al inicio
    const todosLosToasts = document.querySelectorAll('.toast');
    todosLosToasts.forEach(toast => toast.classList.remove('mostrar'));

    // Mostrar el toast de "info" después de 5 segundos
    setTimeout(() => {
